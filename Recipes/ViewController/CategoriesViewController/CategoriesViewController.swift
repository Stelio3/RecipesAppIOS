...
class CategoriesViewController: UIViewController {
    ...
    private func loadAll(){
        ...
        let flan = Recipes(title: "Flan de huevo", imageFood: "http://www.annarecetasfaciles.com/files/flan-de-huevo-3aa-815x458.jpg", description: "Un postre típico que no por ello no deja de estar bueno", ingredients: "4 huevos 1 yema 500 ml, de leche entera 120 gramos, de azúcar 1 rama de vainilla o esencia", time: "30 minutos", dificult: "fácil")
